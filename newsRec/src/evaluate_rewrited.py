...
if __name__ == '__main__':
    ...
    rewrited_target_path = path.join(target_dir, 'rewrited_target_' + config.target_trainORtest + "_" + config.diverse_mode + '.pkl')
    
    result = compute_rank_metrics(
    ...
    # Save the result
    with open(path.join(target_dir, f'{model_name}_rewrited_target_' + config.target_trainORtest + "_" + config.diverse_mode + '_metrics_result.pkl'), "wb") as f:
        pickle.dump(result, f)
    print("Rank information saved to " + path.join(target_dir, f'{model_name}_rewrited_target_' + config.target_trainORtest + "_" + config.diverse_mode + '_metrics_result.pkl'))


    with open(path.join(target_dir, f'{model_name}_rewrited_target_' + config.target_trainORtest + "_" + config.diverse_mode + '_metrics_result.pkl'), "rb") as f:
