...
if __name__ == '__main__':
    ...
    train_dir = '/data/XXXXXXXX/ndata/data/original/train'
    val_dir = '/data/XXXXXXXX/ndata/data/original/val'
    test_dir = '/data/XXXXXXXX/ndata/data/original/test'
    target_dir = '/data/XXXXXXXX/ndata/data/target'

    target_path = path.join(target_dir, train_or_test[args.target_trainORtest])
    prompts_path = 'prompts/' + diverse_prompt_dict[args.diverse_mode]
    ...
    for news in iter_target_news(target_path):
        rewrited_news = rewrite_process(news, prompts_path, api_mode=args.llm_api_mode)
    ...
    rewrited_target_path = path.join(target_dir, 'rewrited_target_' + args.target_trainORtest + "_" + args.diverse_mode + "_" + args.llm_api_mode + '.pkl')
    print("Success num of rewrited_news_collection is:  {success_num}.".format(success_num=len(rewrited_news_collection['index'])))
