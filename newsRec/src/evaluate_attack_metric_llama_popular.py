...
if __name__ == '__main__':
    ...
    if config.llm_name == 'llama3_base' or config.llm_name == 'llama3_mind_pretrain_news_content' or config.llm_name == 'llama3_multi_merged_dpo':
        model_name = 'ALL'
    rewrited_target_path = path.join(target_llama_dir, 'rewrited_target_popular_' + model_name + "_" + config.news_encoder + "_" + config.target_trainORtest + "_" + config.diverse_mode + '.pkl')
