...
parser.add_argument('--current_data_path', type=str, default='/var/scratch/XXXXX/newsRec/data',
                    help='llm or Copycat, etc. ')
parser.add_argument('--attack_folder', type=str, default='/var/scratch/XXXXX/newsRec/data/attack',
                    help='llm or Copycat, etc. ')
parser.add_argument('--gpt4_attack_text_path', type=str, default="/data/XXXXX/news_data/data/gpt_data/test/data_at_interaction_598.json",
                    help='llm or Copycat, etc. ')
...
parser.add_argument('--original_data_path', type=str, default='/var/scratch/XXXXX/newsRec/data/original',
...
parser.add_argument('--batch_size', type=int, default=64,
                    help='batch size')
parser.add_argument('--pretrained_model_name', type=str, default='/var/scratch/XXXXX/llms/bert-base-uncased',
...
parser.add_argument('--diverse_mode', type=str, default='improve',
                    help='Select one from `writing_style`, `sentiment` and `persona`')
parser.add_argument('--llm_api_mode', type=str, default='gpt-4o',
                    help='Select one from api_mode: `gpt-4`, `gpt-4o`,`gpt-3.5-turbo`, `gemini-1.5-pro`, `o1`, `o1-mini`, .')
parser.add_argument('--news_encoder', type=str, default='bert',
                    help='Select one from model name: `glove`, `bert`,`llama`.')
parser.add_argument('--llm_name', type=str, default='llama3_mind_pretrain_news_content',
                    help='Select one from llm finetuned.')
parser.add_argument('--llm_test_version', type=int, default=0,
                        help='Select one from test version.')
...
class BaseConfig():
    ...
    """
    llm_test_version = args.llm_test_version
    news_encoder = args.news_encoder
    llm_name = args.llm_name
    llm_api_mode = args.llm_api_mode
    target_trainORtest = args.target_trainORtest
    ...
    home_folder = '/data/XXXXX/news_data'
    seed = 2024
