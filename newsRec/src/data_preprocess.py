...
parser.add_argument('--pretrained_model_name', type=str, default='/var/scratch/XXXXXXXX/llms/bert-base-uncased',
...
if __name__ == '__main__':
    train_dir = '/var/scratch/XXXXXXXX/newsRec/data/original/train'
    val_dir = '/var/scratch/XXXXXXXX/newsRec/data/original/val'
    test_dir = '/var/scratch/XXXXXXXX/newsRec/data/original/test'
