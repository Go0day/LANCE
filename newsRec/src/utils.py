...
prompts_path = '/home/XXXXXXXX/sui4/XXXXXXXX/news-recommendation/src/prompts/'
prompt_file = 'mind_prompt.json'
...
def pretrained_encode_glove(news_dataframe, num_title, num_abstract):
    ...
    glove_path = "/var/scratch/XXXXXXXX/llms/glove/glove.840B.300d.txt"
...
#     model_id = "/var/scratch/XXXXXXXX/llms/Meta-Llama-3.1-8B-Instruct"
...
def pretrained_encode_llama(news_dataframe, repeat_times_title, repeat_times_abstract):
    ...
    # Load LLaMA model and tokenizer
    model_path = "/var/scratch/XXXXXXXX/llms/Meta-Llama-3.1-8B-Instruct"
